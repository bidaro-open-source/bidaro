...
import { confirmReceiveLotRequest } from '~~/test/utils/requests/lots'

describe('post /api/lots/:id/confirm-receive', async () => {
  await setup()

  it('should confrim receive', async () => {
    ...
    const response = await confirmReceiveLotRequest(
    ...
    expect(lot.status).toBe(lotStatuses.RECEIVED)
  ...
  describe('error handling', () => {
    ...
    it('should return 400 when a lot is alian', async () => {
